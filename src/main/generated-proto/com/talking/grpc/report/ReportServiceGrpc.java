...
public final class ReportServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.talking.grpc.report.PostReportRequest,
      com.google.protobuf.Empty> getPostReportMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PostReport",
      requestType = com.talking.grpc.report.PostReportRequest.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.talking.grpc.report.PostReportRequest,
      com.google.protobuf.Empty> getPostReportMethod() {
    io.grpc.MethodDescriptor<com.talking.grpc.report.PostReportRequest, com.google.protobuf.Empty> getPostReportMethod;
    if ((getPostReportMethod = ReportServiceGrpc.getPostReportMethod) == null) {
      synchronized (ReportServiceGrpc.class) {
        if ((getPostReportMethod = ReportServiceGrpc.getPostReportMethod) == null) {
          ReportServiceGrpc.getPostReportMethod = getPostReportMethod =
              io.grpc.MethodDescriptor.<com.talking.grpc.report.PostReportRequest, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PostReport"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.talking.grpc.report.PostReportRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.protobuf.Empty.getDefaultInstance()))
              .setSchemaDescriptor(new ReportServiceMethodDescriptorSupplier("PostReport"))
              .build();
        }
      }
    }
    return getPostReportMethod;
  }
  ...
  public static abstract class ReportServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void postReport(com.talking.grpc.report.PostReportRequest request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      asyncUnimplementedUnaryCall(getPostReportMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.talking.grpc.report.PostReportRequest,
                com.google.protobuf.Empty>(
                  this, METHODID_POST_REPORT)))
          .build();
    }
  }
  ...
  public static final class ReportServiceStub extends io.grpc.stub.AbstractStub<ReportServiceStub> {
    ...
    public void postReport(com.talking.grpc.report.PostReportRequest request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getPostReportMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ReportServiceBlockingStub extends io.grpc.stub.AbstractStub<ReportServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.protobuf.Empty postReport(com.talking.grpc.report.PostReportRequest request) {
      return blockingUnaryCall(
          getChannel(), getPostReportMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class ReportServiceFutureStub extends io.grpc.stub.AbstractStub<ReportServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> postReport(
        com.talking.grpc.report.PostReportRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getPostReportMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_POST_REPORT = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_POST_REPORT:
          serviceImpl.postReport((com.talking.grpc.report.PostReportRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
  ...
  private static abstract class ReportServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.talking.grpc.report.Report.getDescriptor();
    }
